...
import CounterBid from '../Components/CounterBid';
var W3CWebSocket = require('websocket').w3cwebsocket;



export default function CounterBidsScreen({ route, navigation }) {
    ...
    useEffect(() => {
        ...
        client.onopen = function () {
            ...
            client.send(JSON.stringify({ "type": "GET_COUNTER_BIDS","userId":userId}));
        ...
        client.onmessage = function (e) {
            ...
            if (parsedMessage.type == "GET_COUNTER_BIDS") {
