...
export default function AddStoreDiscountPolicy({ route, navigation }) {
            ...
            <View style={{ padding: 5, flexDirection: 'row' }}>
                <View style={{ padding: 5 }}>
                    <View style={{ padding: 5, borderWidth: 2, borderRadius: 3, borderColor: 'grey' }}>
                        ...
                        <View style={{ padding: 5 }}>
                            <Button title={'On Product'} onPress={() => { navigation.navigate("DiscountScreen", { userId: userId, storeId: storeId, basedOn: 'product',productId:productId, registered: registered }) }} />
                        </View>
                    </View>
                </View>
                <View style={{ padding: 5 }}>
                    <View style={{ padding: 5, borderWidth: 2, borderRadius: 3, borderColor: 'grey' }}>
                        ...
                        <View style={{ padding: 5 }}>
                            <Button title={'On Category'} onPress={() => { navigation.navigate("DiscountScreen", { userId: userId, storeId: storeId, basedOn: 'category',category:category, registered: registered }) }} />
                        </View>
                    </View>
                </View>
                <View style={{ alignSelf:'center', padding: 5 }}>
                    <View style={{ padding: 5, borderWidth: 2, borderRadius: 3, borderColor: 'grey' }}>
                        <View style={{ alignSelf: 'center', padding: 5 }}>
                            <Button title={'On Store'} onPress={() => { navigation.navigate("DiscountScreen", { userId: userId, storeId: storeId, basedOn: 'store', registered: registered }) }} />
                        </View>
